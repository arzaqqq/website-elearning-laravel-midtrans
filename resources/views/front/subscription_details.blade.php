...
@section('title', 'Detail Subscription - Obito BuildWithAngga')
@section('content')
    <x-navigation-auth />
                ...
                <section id="transaction-details" class="flex flex-col gap-[12px]">
                    ...
                    <div class="flex flex-col gap-[12px]">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">{{ $transaction->pricing->duration }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-5 shrink-0" />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">{{ number_format($transaction->sub_tax_amount, 0, '', '.') }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-5 shrink-0" />
                            ...
                            <strong class="font-bold text-obito-green text-[22px] leading-[33px]"> {{ number_format($transaction->grand_total_amount, 0, '', '.') }} </strong>
                        </div>
                    </div>
                </section>
